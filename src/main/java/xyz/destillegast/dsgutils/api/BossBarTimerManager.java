...
public interface BossBarTimerManager {
    ...
    BossBarTimer createBossBarTimer(@Nonnull List<Player> players, @Nonnull String message, long duration, @Nonnull TimeUnit timeUnit, @Nullable Runnable finishAction);
    ...
    BossBarTimer createBossBarTimer(@Nonnull List<Player> player, @Nonnull String message, long duration, @Nonnull TimeUnit timeUnit, @Nonnull BarColor bossBarColor, @Nonnull BarStyle bossBarStyle, @Nullable Runnable finishAction);
